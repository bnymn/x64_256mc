...
void x64_256mc_mul_n_test()
{
	...
	b[0] = 0x0000000000000000L;
	b[1] = 0x0000000000000000L;
	b[2] = 0x0000000000000000L;
	b[3] = 0x0000000000000000L;
	*/
	for(i=0; i<10000; i++)
	{
		...
		sprintf(str, "if ( (a*b) mod P ) ne r then err := err + 1; end if;\n\n");
		fputs(str, file);
